...
export default function LandingPage() {
  return (
    <div className="max-w-5xl mx-auto py-3 px-4 animate-fade-in text-center mt-1">
      {/* Version Badge */}
      ...
      {/* Hero Text */}
      <h1 className="text-2xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 leading-tight">
      ...
      <SignInButton mode="modal">
        <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-4 py-2 rounded-2xl transition-all shadow-lg shadow-blue-200 flex items-center gap-2 mx-auto cursor-pointer">
